...
public object MessagingKt {
  ...
  @kotlin.PublishedApi
    ...
    public var dtnResponse: qaul.net.messaging.MessagingOuterClass.DtnResponse
      @kotlin.jvm.JvmName("getDtnResponse")
        get() = _builder.dtnResponse
      @kotlin.jvm.JvmName("setDtnResponse")
        set(value) {
        _builder.dtnResponse = value
      }
    /**
     * ```
     * dtn response message
    ...
    public var cryptoService: qaul.net.messaging.MessagingOuterClass.CryptoService
      @kotlin.jvm.JvmName("getCryptoService")
        get() = _builder.cryptoService
      @kotlin.jvm.JvmName("setCryptoService")
        set(value) {
        _builder.cryptoService = value
      }
    /**
     * ```
     * crypto service
    ...
    public var rtcStreamMessage: qaul.net.messaging.MessagingOuterClass.RtcStreamMessage
      @kotlin.jvm.JvmName("getRtcStreamMessage")
        get() = _builder.rtcStreamMessage
      @kotlin.jvm.JvmName("setRtcStreamMessage")
        set(value) {
        _builder.rtcStreamMessage = value
      }
    /**
     * ```
     * rtc stream
    ...
    public var groupInviteMessage: qaul.net.messaging.MessagingOuterClass.GroupInviteMessage
      @kotlin.jvm.JvmName("getGroupInviteMessage")
        get() = _builder.groupInviteMessage
      @kotlin.jvm.JvmName("setGroupInviteMessage")
        set(value) {
        _builder.groupInviteMessage = value
      }
    /**
     * ```
     * group invite messages
    ...
    public var commonMessage: qaul.net.messaging.MessagingOuterClass.CommonMessage
      @kotlin.jvm.JvmName("getCommonMessage")
        get() = _builder.commonMessage
      @kotlin.jvm.JvmName("setCommonMessage")
        set(value) {
        _builder.commonMessage = value
      }
    /**
     * ```
     * common message
