...
public object ChatKt {
  ...
  @kotlin.PublishedApi
    ...
    public var conversationRequest: qaul.rpc.chat.ChatOuterClass.ChatConversationRequest
      @kotlin.jvm.JvmName("getConversationRequest")
        get() = _builder.conversationRequest
      @kotlin.jvm.JvmName("setConversationRequest")
        set(value) {
        _builder.conversationRequest = value
      }
    /**
     * ```
     * request a specific conversation
    ...
    public var conversationList: qaul.rpc.chat.ChatOuterClass.ChatConversationList
      @kotlin.jvm.JvmName("getConversationList")
        get() = _builder.conversationList
      @kotlin.jvm.JvmName("setConversationList")
        set(value) {
        _builder.conversationList = value
      }
    /**
     * ```
     * list of a chat conversation
