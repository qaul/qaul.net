...
public object RouterKt {
  ...
  @kotlin.PublishedApi
    ...
    public var routingTableRequest: qaul.rpc.router.RouterOuterClass.RoutingTableRequest
      @kotlin.jvm.JvmName("getRoutingTableRequest")
        get() = _builder.routingTableRequest
      @kotlin.jvm.JvmName("setRoutingTableRequest")
        set(value) {
        _builder.routingTableRequest = value
      }
    /**
     * `.qaul.rpc.router.RoutingTableRequest routing_table_request = 1;`
     */
    ...
    public var routingTable: qaul.rpc.router.RouterOuterClass.RoutingTableList
      @kotlin.jvm.JvmName("getRoutingTable")
        get() = _builder.routingTable
      @kotlin.jvm.JvmName("setRoutingTable")
        set(value) {
        _builder.routingTable = value
      }
    /**
     * `.qaul.rpc.router.RoutingTableList routing_table = 2;`
     */
    ...
    public var connectionsRequest: qaul.rpc.router.RouterOuterClass.ConnectionsRequest
      @kotlin.jvm.JvmName("getConnectionsRequest")
        get() = _builder.connectionsRequest
      @kotlin.jvm.JvmName("setConnectionsRequest")
        set(value) {
        _builder.connectionsRequest = value
      }
    /**
     * `.qaul.rpc.router.ConnectionsRequest connections_request = 3;`
     */
    ...
    public var connectionsList: qaul.rpc.router.RouterOuterClass.ConnectionsList
      @kotlin.jvm.JvmName("getConnectionsList")
        get() = _builder.connectionsList
      @kotlin.jvm.JvmName("setConnectionsList")
        set(value) {
        _builder.connectionsList = value
      }
    /**
     * `.qaul.rpc.router.ConnectionsList connections_list = 4;`
     */
    ...
    public var neighboursRequest: qaul.rpc.router.RouterOuterClass.NeighboursRequest
      @kotlin.jvm.JvmName("getNeighboursRequest")
        get() = _builder.neighboursRequest
      @kotlin.jvm.JvmName("setNeighboursRequest")
        set(value) {
        _builder.neighboursRequest = value
      }
    /**
     * `.qaul.rpc.router.NeighboursRequest neighbours_request = 5;`
     */
    ...
    public var neighboursList: qaul.rpc.router.RouterOuterClass.NeighboursList
      @kotlin.jvm.JvmName("getNeighboursList")
        get() = _builder.neighboursList
      @kotlin.jvm.JvmName("setNeighboursList")
        set(value) {
        _builder.neighboursList = value
      }
    /**
     * `.qaul.rpc.router.NeighboursList neighbours_list = 6;`
     */
