...
public object ChatFileKt {
  ...
  @kotlin.PublishedApi
    ...
    public var sendFileRequest: qaul.rpc.chatfile.ChatfileRpc.SendFileRequest
      @kotlin.jvm.JvmName("getSendFileRequest")
        get() = _builder.sendFileRequest
      @kotlin.jvm.JvmName("setSendFileRequest")
        set(value) {
        _builder.sendFileRequest = value
      }
    /**
     * ```
     * send file request
    ...
    public var sendFileResponse: qaul.rpc.chatfile.ChatfileRpc.SendFileResponse
      @kotlin.jvm.JvmName("getSendFileResponse")
        get() = _builder.sendFileResponse
      @kotlin.jvm.JvmName("setSendFileResponse")
        set(value) {
        _builder.sendFileResponse = value
      }
    /**
     * ```
     * send file response
    ...
    public var fileHistory: qaul.rpc.chatfile.ChatfileRpc.FileHistoryRequest
      @kotlin.jvm.JvmName("getFileHistory")
        get() = _builder.fileHistory
      @kotlin.jvm.JvmName("setFileHistory")
        set(value) {
        _builder.fileHistory = value
      }
    /**
     * ```
     * file history request
    ...
    public var fileHistoryResponse: qaul.rpc.chatfile.ChatfileRpc.FileHistoryResponse
      @kotlin.jvm.JvmName("getFileHistoryResponse")
        get() = _builder.fileHistoryResponse
      @kotlin.jvm.JvmName("setFileHistoryResponse")
        set(value) {
        _builder.fileHistoryResponse = value
      }
    /**
     * ```
     * file history response
