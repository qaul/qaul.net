...
public object ConnectionsKt {
  ...
  @kotlin.PublishedApi
    ...
    public var internetNodesRequest: qaul.rpc.connections.ConnectionsOuterClass.InternetNodesRequest
      @kotlin.jvm.JvmName("getInternetNodesRequest")
        get() = _builder.internetNodesRequest
      @kotlin.jvm.JvmName("setInternetNodesRequest")
        set(value) {
        _builder.internetNodesRequest = value
      }
    /**
     * ```
     * Request a list of all internet nodes.
    ...
    public var internetNodesList: qaul.rpc.connections.ConnectionsOuterClass.InternetNodesList
      @kotlin.jvm.JvmName("getInternetNodesList")
        get() = _builder.internetNodesList
      @kotlin.jvm.JvmName("setInternetNodesList")
        set(value) {
        _builder.internetNodesList = value
      }
    /**
     * ```
     * returns a list of all internet nodes and
    ...
    public var internetNodesAdd: qaul.rpc.connections.ConnectionsOuterClass.InternetNodesEntry
      @kotlin.jvm.JvmName("getInternetNodesAdd")
        get() = _builder.internetNodesAdd
      @kotlin.jvm.JvmName("setInternetNodesAdd")
        set(value) {
        _builder.internetNodesAdd = value
      }
    /**
     * ```
     * Add a new internet node address.
    ...
    public var internetNodesRemove: qaul.rpc.connections.ConnectionsOuterClass.InternetNodesEntry
      @kotlin.jvm.JvmName("getInternetNodesRemove")
        get() = _builder.internetNodesRemove
      @kotlin.jvm.JvmName("setInternetNodesRemove")
        set(value) {
        _builder.internetNodesRemove = value
      }
    /**
     * ```
     * Remove an internet node address.
    ...
    public var internetNodesState: qaul.rpc.connections.ConnectionsOuterClass.InternetNodesEntry
      @kotlin.jvm.JvmName("getInternetNodesState")
        get() = _builder.internetNodesState
      @kotlin.jvm.JvmName("setInternetNodesState")
        set(value) {
        _builder.internetNodesState = value
      }
    /**
     * ```
     * Update an internet node state.
    ...
    public var internetNodesRename: qaul.rpc.connections.ConnectionsOuterClass.InternetNodesEntry
      @kotlin.jvm.JvmName("getInternetNodesRename")
        get() = _builder.internetNodesRename
      @kotlin.jvm.JvmName("setInternetNodesRename")
        set(value) {
        _builder.internetNodesRename = value
      }
    /**
     * ```
     * Rename internet node.
