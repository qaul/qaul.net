...
/// handed to.
enum Qaul_Rpc_Modules: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Qaul_Rpc_Modules] = [
    .none,
    .rpc,
    .node,
    .useraccounts,
...
/// into this container.
struct Qaul_Rpc_QaulRpc: Sendable {
...
extension Qaul_Rpc_Modules: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0NONE\0\u{1}RPC\0\u{1}NODE\0\u{1}USERACCOUNTS\0\u{1}USERS\0\u{1}ROUTER\0\u{1}FEED\0\u{1}CONNECTIONS\0\u{1}DEBUG\0\u{1}GROUP\0\u{1}CHAT\0\u{1}CHATFILE\0\u{1}BLE\0\u{1}RTC\0\u{1}DTN\0\u{1}AUTH\0")
}
...
extension Qaul_Rpc_QaulRpc: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}module\0\u{3}request_id\0\u{3}user_id\0\u{1}data\0")
