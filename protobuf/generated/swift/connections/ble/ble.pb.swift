...
/// power modes.
enum Qaul_Sys_Ble_BlePowerSetting: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Qaul_Sys_Ble_BlePowerSetting] = [
    .lowPower,
    .balanced,
    .lowLatency,
  ]
...
///       UNKNOWN_ERROR
enum Qaul_Sys_Ble_BleError: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Qaul_Sys_Ble_BleError] = [
    .unknownError,
    .rightsMissing,
    .timeout,
    .deviceUnavailable,
...
struct Qaul_Sys_Ble_Ble: Sendable {
...
struct Qaul_Sys_Ble_BleInfoRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Sys_Ble_BleInfoResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var device: Qaul_Sys_Ble_BleDeviceInfo {
    get {_device ?? Qaul_Sys_Ble_BleDeviceInfo()}
...
struct Qaul_Sys_Ble_BleDeviceInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Sys_Ble_BleStartRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///
/// Feedback from the
struct Qaul_Sys_Ble_BleStartResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Sys_Ble_BleStopRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Sys_Ble_BleStopResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Sys_Ble_BleDeviceDiscovered: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Sys_Ble_BleDeviceUnavailable: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// send a direct message
struct Qaul_Sys_Ble_BleDirectSend: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Sys_Ble_BleDirectSendResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Sys_Ble_BleDirectReceived: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Qaul_Sys_Ble_BlePowerSetting: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0low_power\0\u{1}balanced\0\u{1}low_latency\0")
}

extension Qaul_Sys_Ble_BleError: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_ERROR\0\u{1}RIGHTS_MISSING\0\u{1}TIMEOUT\0\u{1}DEVICE_UNAVAILABLE\0")
}
...
extension Qaul_Sys_Ble_Ble: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}info_request\0\u{3}info_response\0\u{3}start_request\0\u{3}start_result\0\u{3}stop_request\0\u{3}stop_result\0\u{3}device_discovered\0\u{3}device_unavailable\0\u{3}direct_send\0\u{3}direct_send_result\0\u{3}direct_received\0")
...
extension Qaul_Sys_Ble_BleDeviceInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}ble_support\0\u{1}id\0\u{1}name\0\u{3}bluetooth_on\0\u{3}adv_extended\0\u{3}adv_extended_bytes\0\u{3}le_2m\0\u{3}le_coded\0\u{3}le_audio\0\u{4}\u{5}le_periodic_adv_support\0\u{3}le_multiple_adv_support\0\u{3}offload_filter_support\0\u{3}offload_scan_batching_support\0")
...
extension Qaul_Sys_Ble_BleStartRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}qaul_id\0\u{3}power_setting\0")
...
extension Qaul_Sys_Ble_BleStartResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}success\0\u{3}error_reason\0\u{3}error_message\0")
...
extension Qaul_Sys_Ble_BleDeviceDiscovered: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}qaul_id\0\u{1}rssi\0")
...
extension Qaul_Sys_Ble_BleDeviceUnavailable: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}qaul_id\0")
...
extension Qaul_Sys_Ble_BleDirectSend: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}message_id\0\u{3}receiver_id\0\u{3}sender_id\0\u{1}data\0")
...
extension Qaul_Sys_Ble_BleDirectSendResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}success\0\u{3}error_message\0")
...
extension Qaul_Sys_Ble_BleDirectReceived: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}from\0\u{2}\u{3}data\0")
