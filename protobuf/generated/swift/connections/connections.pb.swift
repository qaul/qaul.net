...
enum Qaul_Rpc_Connections_Info: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Qaul_Rpc_Connections_Info] = [
    .request,
    .addSuccess,
    .addErrorInvalid,
    .removeSuccess,
...
struct Qaul_Rpc_Connections_Connections: Sendable {
...
struct Qaul_Rpc_Connections_InternetNodesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Rpc_Connections_InternetNodesList: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Rpc_Connections_InternetNodesEntry: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Qaul_Rpc_Connections_Info: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0REQUEST\0\u{1}ADD_SUCCESS\0\u{1}ADD_ERROR_INVALID\0\u{2}\u{3}REMOVE_SUCCESS\0\u{1}STATE_SUCCESS\0\u{1}REMOVE_ERROR_NOT_FOUND\0")
}
...
extension Qaul_Rpc_Connections_Connections: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}internet_nodes_request\0\u{3}internet_nodes_list\0\u{3}internet_nodes_add\0\u{3}internet_nodes_remove\0\u{3}internet_nodes_state\0\u{3}internet_nodes_rename\0")
...
extension Qaul_Rpc_Connections_InternetNodesList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}info\0\u{1}nodes\0")
...
extension Qaul_Rpc_Connections_InternetNodesEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}address\0\u{1}enabled\0\u{1}name\0")
