...
/// RouterInfoModule
enum Qaul_Net_RouterNetInfo_RouterInfoModule: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Qaul_Net_RouterNetInfo_RouterInfoModule] = [
    .routerInfo,
    .feedRequest,
    .feedResponse,
    .userRequest,
...
struct Qaul_Net_RouterNetInfo_RouterInfoContainer: Sendable {
...
struct Qaul_Net_RouterNetInfo_RouterInfoContent: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Net_RouterNetInfo_RouterInfoMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var routes: Qaul_Net_RouterNetInfo_RoutingInfoTable {
    get {_routes ?? Qaul_Net_RouterNetInfo_RoutingInfoTable()}
    set {_routes = newValue}
  }
  /// Returns true if `routes` has been explicitly set.
  var hasRoutes: Bool {self._routes != nil}
  ...
  var feeds: Qaul_Net_RouterNetInfo_FeedIdsTable {
    get {_feeds ?? Qaul_Net_RouterNetInfo_FeedIdsTable()}
    set {_feeds = newValue}
  }
  /// Returns true if `feeds` has been explicitly set.
  var hasFeeds: Bool {self._feeds != nil}
...
struct Qaul_Net_RouterNetInfo_RoutingInfoTable: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Net_RouterNetInfo_RoutingInfoEntry: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Net_RouterNetInfo_UserIdTable: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// User information table
struct Qaul_Net_RouterNetInfo_UserInfoTable: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Net_RouterNetInfo_UserInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// List of feed ID's
struct Qaul_Net_RouterNetInfo_FeedIdsTable: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Net_RouterNetInfo_FeedRequestMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Net_RouterNetInfo_FeedResponseMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var feeds: Qaul_Net_RouterNetInfo_FeedResponseTable {
    get {_feeds ?? Qaul_Net_RouterNetInfo_FeedResponseTable()}
    set {_feeds = newValue}
  }
  /// Returns true if `feeds` has been explicitly set.
  var hasFeeds: Bool {self._feeds != nil}
...
struct Qaul_Net_RouterNetInfo_FeedResponseTable: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Feed Message
struct Qaul_Net_RouterNetInfo_FeedMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Qaul_Net_RouterNetInfo_RouterInfoModule: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0ROUTER_INFO\0\u{1}FEED_REQUEST\0\u{1}FEED_RESPONSE\0\u{1}USER_REQUEST\0\u{1}USER_RESPONSE\0")
}
...
extension Qaul_Net_RouterNetInfo_RouterInfoContainer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}signature\0\u{1}message\0")
...
extension Qaul_Net_RouterNetInfo_RouterInfoContent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}routerInfoModule\0\u{1}content\0\u{1}time\0")
...
extension Qaul_Net_RouterNetInfo_RouterInfoMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}node\0\u{1}routes\0\u{2}\u{2}feeds\0\u{1}timestamp\0")
...
extension Qaul_Net_RouterNetInfo_RoutingInfoEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}user\0\u{1}rtt\0\u{1}hc\0\u{2}\u{2}pgid\0")
...
extension Qaul_Net_RouterNetInfo_UserInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}key\0\u{1}name\0")
...
extension Qaul_Net_RouterNetInfo_FeedRequestMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}feeds\0")
...
extension Qaul_Net_RouterNetInfo_FeedMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}message_id\0\u{3}sender_id\0\u{1}content\0\u{1}time\0")
