...
/// Group member state
enum Qaul_Rpc_Group_GroupMemberState: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Qaul_Rpc_Group_GroupMemberState] = [
    .invited,
    .activated,
  ]
...
/// Group member role
enum Qaul_Rpc_Group_GroupMemberRole: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Qaul_Rpc_Group_GroupMemberRole] = [
    .user,
    .admin,
  ]
...
enum Qaul_Rpc_Group_GroupStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Qaul_Rpc_Group_GroupStatus] = [
    .active,
    .inviteAccepted,
    .deactivated,
  ]
...
struct Qaul_Rpc_Group_Group: Sendable {
...
/// Group Result
struct Qaul_Rpc_Group_GroupResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Create New Group
struct Qaul_Rpc_Group_GroupCreateRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Rpc_Group_GroupCreateResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var result: Qaul_Rpc_Group_GroupResult {
    get {_result ?? Qaul_Rpc_Group_GroupResult()}
...
/// Group rename request
struct Qaul_Rpc_Group_GroupRenameRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Group rename response
struct Qaul_Rpc_Group_GroupRenameResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Invite member
struct Qaul_Rpc_Group_GroupInviteMemberRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Rpc_Group_GroupInviteMemberResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Reply Invite
struct Qaul_Rpc_Group_GroupReplyInviteRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Rpc_Group_GroupReplyInviteResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Remove member
struct Qaul_Rpc_Group_GroupRemoveMemberRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Remove member
struct Qaul_Rpc_Group_GroupRemoveMemberResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Group info request
struct Qaul_Rpc_Group_GroupInfoRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Rpc_Group_GroupMember: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Group info response
struct Qaul_Rpc_Group_GroupInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Group list request
struct Qaul_Rpc_Group_GroupListRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Group info response
struct Qaul_Rpc_Group_GroupListResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Qaul_Rpc_Group_GroupInvited: Sendable {
  ...
  var group: Qaul_Rpc_Group_GroupInfo {
    get {_group ?? Qaul_Rpc_Group_GroupInfo()}
    set {_group = newValue}
  }
...
extension Qaul_Rpc_Group_GroupStatus: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0ACTIVE\0\u{1}INVITE_ACCEPTED\0\u{1}DEACTIVATED\0")
}
...
extension Qaul_Rpc_Group_Group: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}group_create_request\0\u{3}group_create_response\0\u{3}group_rename_request\0\u{3}group_rename_response\0\u{3}group_invite_member_request\0\u{3}group_invite_member_response\0\u{3}group_remove_member_request\0\u{3}group_remove_member_response\0\u{3}group_info_request\0\u{3}group_info_response\0\u{3}group_reply_invite_request\0\u{3}group_reply_invite_response\0\u{3}group_list_request\0\u{3}group_list_response\0\u{3}group_invited_request\0\u{3}group_invited_response\0")
...
extension Qaul_Rpc_Group_GroupCreateRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}group_name\0")
...
extension Qaul_Rpc_Group_GroupCreateResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}group_id\0\u{1}result\0")
...
extension Qaul_Rpc_Group_GroupRenameRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}group_id\0\u{3}group_name\0")
...
extension Qaul_Rpc_Group_GroupRenameResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}group_id\0\u{3}group_name\0\u{1}result\0")
...
extension Qaul_Rpc_Group_GroupInviteMemberRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}group_id\0\u{3}user_id\0")
...
extension Qaul_Rpc_Group_GroupInviteMemberResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}group_id\0\u{3}user_id\0\u{1}result\0")
...
extension Qaul_Rpc_Group_GroupReplyInviteRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}group_id\0\u{2}\u{2}accept\0")
...
extension Qaul_Rpc_Group_GroupReplyInviteResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}group_id\0\u{2}\u{2}result\0")
...
extension Qaul_Rpc_Group_GroupInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}group_id\0\u{3}group_name\0\u{3}created_at\0\u{1}status\0\u{1}revision\0\u{3}is_direct_chat\0\u{1}members\0\u{3}unread_messages\0\u{3}last_message_at\0\u{3}last_message\0\u{3}last_message_sender_id\0")
...
extension Qaul_Rpc_Group_GroupInvited: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}sender_id\0\u{3}received_at\0\u{1}group\0")
