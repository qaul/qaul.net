...
impl RotationEventKind {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::MessageDroppedPostDrain => "MESSAGE_DROPPED_POST_DRAIN",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "DRAIN_COMPLETED" => Some(Self::DrainCompleted),
            "MESSAGE_DROPPED_POST_DRAIN" => Some(Self::MessageDroppedPostDrain),
            _ => None,
        }
    }
}
