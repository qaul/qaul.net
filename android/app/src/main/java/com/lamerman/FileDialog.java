/*
 * Code from Android File Dialog by Alexander Ponomarev
 * New BSD License
...
public class FileDialog extends ListActivity {
	...
	private void getDirImpl(final String dirPath) {
		...
		if (!currentPath.equals(ROOT)) {
			...
			item.add(ROOT);
			addItem(ROOT, R.drawable.folder_root);
			path.add(ROOT);

			item.add("../");
			addItem("../", R.drawable.folder_moveup);
