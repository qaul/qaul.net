# qaul Protobuf Messaging Structure
...
- `src/services/messaging/messaging.proto` - Core messaging structures
- `src/services/chat/chatfile_net.proto` - File transfer protocol
- `src/services/group/group_net.proto` - Group management protocol
