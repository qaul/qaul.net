...
impl Ble {
    ...
    fn send_handshake_message(receiver_small_id: Vec<u8>, handshake: proto_net::NoiseHandshake) {
        log::info!("BLE sending handshake message {} to {:?}", handshake.message_number, receiver_small_id);
    ...
    fn create_send_message_raw(receiver_small_id: Vec<u8>, message: proto_net::ble_message::Message) {
    ...
    fn process_decrypted_message(from: Vec<u8>, node_id: PeerId, ble_message: proto_net::BleMessage) {
    ...
    fn handle_handshake(from: Vec<u8>, remote_id: PeerId, handshake: proto_net::NoiseHandshake) {
        match handshake.message_number {
            ...
            _ => {
                log::error!("BLE invalid handshake message number: {}", handshake.message_number);
            }
        }
    }
