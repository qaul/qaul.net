...
void UserEntry::set_id_base58(ArgT0&& arg0, ArgT... args) {
 ...
 id_base58_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void UserEntry::set_allocated_id_base58(std::string* id_base58) {
  ...
  id_base58_.SetAllocated(id_base58, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (id_base58_.IsDefault()) {
...
void UserEntry::set_key_type(ArgT0&& arg0, ArgT... args) {
 ...
 key_type_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void UserEntry::set_allocated_key_type(std::string* key_type) {
  ...
  key_type_.SetAllocated(key_type, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (key_type_.IsDefault()) {
...
void UserEntry::set_key_base58(ArgT0&& arg0, ArgT... args) {
 ...
 key_base58_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void UserEntry::set_allocated_key_base58(std::string* key_base58) {
  ...
  key_base58_.SetAllocated(key_base58, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (key_base58_.IsDefault()) {
