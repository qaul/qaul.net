...
enum Connectivity : int {
  ...
  Reachable = 1,
  Offline = 2,
  Connectivity_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  Connectivity_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
class Users final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::qaul::rpc::users::UserRequest* release_user_request();
  ...
  PROTOBUF_MUST_USE_RESULT ::qaul::rpc::users::UserList* release_user_list();
  ...
  PROTOBUF_MUST_USE_RESULT ::qaul::rpc::users::UserEntry* release_user_update();
...
class UserRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:qaul.rpc.users.UserRequest) */ {
 public:
...
class UserEntry final :
 ...
 public:
  ...
  inline UserEntry* New() const final {
    return new UserEntry();
  }

  UserEntry* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_id_base58();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_key_type();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_key_base58();
