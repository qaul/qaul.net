...
class FeedRequstMessage;
struct FeedRequstMessageDefaultTypeInternal;
extern FeedRequstMessageDefaultTypeInternal _FeedRequstMessage_default_instance_;
...
template<> ::qaul::net::router_net_info::FeedRequstMessage* Arena::CreateMaybeMessage<::qaul::net::router_net_info::FeedRequstMessage>(Arena*);
...
constexpr RouterInfoModule RouterInfoModule_MAX = FEED_RESPONSE;
...
class FeedRequstMessage final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:qaul.net.router_net_info.FeedRequstMessage) */ {
 public:
  inline FeedRequstMessage() : FeedRequstMessage(nullptr) {}
  ~FeedRequstMessage() override;
  explicit PROTOBUF_CONSTEXPR FeedRequstMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  FeedRequstMessage(const FeedRequstMessage& from);
  FeedRequstMessage(FeedRequstMessage&& from) noexcept
    : FeedRequstMessage() {
    *this = ::std::move(from);
  }

  inline FeedRequstMessage& operator=(const FeedRequstMessage& from) {
    CopyFrom(from);
    return *this;
  }
  inline FeedRequstMessage& operator=(FeedRequstMessage&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const FeedRequstMessage& default_instance() {
    return *internal_default_instance();
  }
  static inline const FeedRequstMessage* internal_default_instance() {
    return reinterpret_cast<const FeedRequstMessage*>(
               &_FeedRequstMessage_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    8;

  friend void swap(FeedRequstMessage& a, FeedRequstMessage& b) {
    a.Swap(&b);
  }
  inline void Swap(FeedRequstMessage* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(FeedRequstMessage* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  FeedRequstMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<FeedRequstMessage>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const FeedRequstMessage& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const FeedRequstMessage& from) {
    FeedRequstMessage::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(FeedRequstMessage* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "qaul.net.router_net_info.FeedRequstMessage";
  }
  protected:
  explicit FeedRequstMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
inline bool RouterInfoMessage::_internal_has_users() const {
  return this != internal_default_instance() && _impl_.users_ != nullptr;
}
...
inline const ::qaul::net::router_net_info::UserInfoTable& RouterInfoMessage::_internal_users() const {
  const ::qaul::net::router_net_info::UserInfoTable* p = _impl_.users_;
...
inline ::qaul::net::router_net_info::UserInfoTable* RouterInfoMessage::release_users() {
  ...
  ::qaul::net::router_net_info::UserInfoTable* temp = _impl_.users_;
  _impl_.users_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
// .qaul.net.router_net_info.FeedIdsTable feeds = 1;
inline bool FeedRequstMessage::_internal_has_feeds() const {
  return this != internal_default_instance() && _impl_.feeds_ != nullptr;
}
inline bool FeedRequstMessage::has_feeds() const {
  return _internal_has_feeds();
}
inline void FeedRequstMessage::clear_feeds() {
  if (GetArenaForAllocation() == nullptr && _impl_.feeds_ != nullptr) {
    delete _impl_.feeds_;
  }
  _impl_.feeds_ = nullptr;
}
inline const ::qaul::net::router_net_info::FeedIdsTable& FeedRequstMessage::_internal_feeds() const {
  const ::qaul::net::router_net_info::FeedIdsTable* p = _impl_.feeds_;
  return p != nullptr ? *p : reinterpret_cast<const ::qaul::net::router_net_info::FeedIdsTable&>(
      ::qaul::net::router_net_info::_FeedIdsTable_default_instance_);
}
inline const ::qaul::net::router_net_info::FeedIdsTable& FeedRequstMessage::feeds() const {
  // @@protoc_insertion_point(field_get:qaul.net.router_net_info.FeedRequstMessage.feeds)
  return _internal_feeds();
}
inline void FeedRequstMessage::unsafe_arena_set_allocated_feeds(
    ::qaul::net::router_net_info::FeedIdsTable* feeds) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.feeds_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:qaul.net.router_net_info.FeedRequstMessage.feeds)
}
inline ::qaul::net::router_net_info::FeedIdsTable* FeedRequstMessage::release_feeds() {
...
inline ::qaul::net::router_net_info::FeedIdsTable* FeedRequstMessage::unsafe_arena_release_feeds() {
  // @@protoc_insertion_point(field_release:qaul.net.router_net_info.FeedRequstMessage.feeds)
  
  ::qaul::net::router_net_info::FeedIdsTable* temp = _impl_.feeds_;
  _impl_.feeds_ = nullptr;
  return temp;
}
inline ::qaul::net::router_net_info::FeedIdsTable* FeedRequstMessage::_internal_mutable_feeds() {
...
inline ::qaul::net::router_net_info::FeedIdsTable* FeedRequstMessage::mutable_feeds() {
  ::qaul::net::router_net_info::FeedIdsTable* _msg = _internal_mutable_feeds();
  // @@protoc_insertion_point(field_mutable:qaul.net.router_net_info.FeedRequstMessage.feeds)
  return _msg;
}
inline void FeedRequstMessage::set_allocated_feeds(::qaul::net::router_net_info::FeedIdsTable* feeds) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.feeds_;
  }
  ...
  _impl_.feeds_ = feeds;
  // @@protoc_insertion_point(field_set_allocated:qaul.net.router_net_info.FeedRequstMessage.feeds)
}
