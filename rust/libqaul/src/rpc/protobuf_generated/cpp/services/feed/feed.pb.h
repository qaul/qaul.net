...
class Feed final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::qaul::rpc::feed::FeedMessageList* release_received();
  ...
  PROTOBUF_MUST_USE_RESULT ::qaul::rpc::feed::SendMessage* release_send();
  ...
  PROTOBUF_MUST_USE_RESULT ::qaul::rpc::feed::FeedMessageRequest* release_request();
...
class FeedMessageRequest final :
 ...
 public:
  ...
  inline FeedMessageRequest* New() const final {
    return new FeedMessageRequest();
  }

  FeedMessageRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_last_received();
...
class FeedMessageList final :
 ...
 public:
  ...
  inline FeedMessageList* New() const final {
    return new FeedMessageList();
  }

  FeedMessageList* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
class FeedMessage final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_sender_id();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_sender_id_base58();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_message_id_base58();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_time_sent();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_time_received();
