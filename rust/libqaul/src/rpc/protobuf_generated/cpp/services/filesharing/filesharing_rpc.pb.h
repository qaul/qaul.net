...
// bool sent = 7;
inline void FileHistoryEntry::clear_sent() {
  _impl_.sent_ = false;
}
inline bool FileHistoryEntry::_internal_sent() const {
  return _impl_.sent_;
}
inline bool FileHistoryEntry::sent() const {
  // @@protoc_insertion_point(field_get:qaul.rpc.filesharing.FileHistoryEntry.sent)
  return _internal_sent();
}
inline void FileHistoryEntry::_internal_set_sent(bool value) {
  
  _impl_.sent_ = value;
}
inline void FileHistoryEntry::set_sent(bool value) {
  _internal_set_sent(value);
  // @@protoc_insertion_point(field_set:qaul.rpc.filesharing.FileHistoryEntry.sent)
}

// string peer_id = 8;
inline void FileHistoryEntry::clear_peer_id() {
  _impl_.peer_id_.ClearToEmpty();
}
inline const std::string& FileHistoryEntry::peer_id() const {
  // @@protoc_insertion_point(field_get:qaul.rpc.filesharing.FileHistoryEntry.peer_id)
  return _internal_peer_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void FileHistoryEntry::set_peer_id(ArgT0&& arg0, ArgT... args) {
 
 _impl_.peer_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:qaul.rpc.filesharing.FileHistoryEntry.peer_id)
}
inline std::string* FileHistoryEntry::mutable_peer_id() {
  std::string* _s = _internal_mutable_peer_id();
  // @@protoc_insertion_point(field_mutable:qaul.rpc.filesharing.FileHistoryEntry.peer_id)
  return _s;
}
inline const std::string& FileHistoryEntry::_internal_peer_id() const {
  return _impl_.peer_id_.Get();
}
inline void FileHistoryEntry::_internal_set_peer_id(const std::string& value) {
  
  _impl_.peer_id_.Set(value, GetArenaForAllocation());
}
inline std::string* FileHistoryEntry::_internal_mutable_peer_id() {
  
  return _impl_.peer_id_.Mutable(GetArenaForAllocation());
}
inline std::string* FileHistoryEntry::release_peer_id() {
  // @@protoc_insertion_point(field_release:qaul.rpc.filesharing.FileHistoryEntry.peer_id)
  return _impl_.peer_id_.Release();
}
inline void FileHistoryEntry::set_allocated_peer_id(std::string* peer_id) {
  if (peer_id != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:qaul.rpc.filesharing.FileHistoryEntry.peer_id)
}
