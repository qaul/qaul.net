...
class Node final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::qaul::rpc::node::NodeInformation* release_info();
...
class NodeInformation final :
 ...
 public:
  ...
  inline NodeInformation* New() const final {
    return new NodeInformation();
  }

  NodeInformation* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
