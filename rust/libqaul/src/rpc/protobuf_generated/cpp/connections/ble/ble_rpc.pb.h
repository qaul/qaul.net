...
void InfoResponse::set_small_id(ArgT0&& arg0, ArgT... args) {
 ...
 small_id_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void InfoResponse::set_allocated_small_id(std::string* small_id) {
  ...
  small_id_.SetAllocated(small_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (small_id_.IsDefault()) {
