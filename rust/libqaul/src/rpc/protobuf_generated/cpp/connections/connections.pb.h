...
class Connections final :
 ...
 public:
  ...
  inline Connections* New() const final {
    return new Connections();
  }

  Connections* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  PROTOBUF_MUST_USE_RESULT ::qaul::rpc::connections::InternetNodesRequest* release_internet_nodes_request();
  ...
  PROTOBUF_MUST_USE_RESULT ::qaul::rpc::connections::InternetNodesList* release_internet_nodes_list();
  ...
  PROTOBUF_MUST_USE_RESULT ::qaul::rpc::connections::InternetNodesEntry* release_internet_nodes_add();
  ...
  PROTOBUF_MUST_USE_RESULT ::qaul::rpc::connections::InternetNodesEntry* release_internet_nodes_remove();
...
class InternetNodesRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:qaul.rpc.connections.InternetNodesRequest) */ {
 public:
  inline InternetNodesRequest() : InternetNodesRequest(nullptr) {}
  ~InternetNodesRequest() override;
  ...
  inline InternetNodesRequest* New() const final {
    return new InternetNodesRequest();
  }

  InternetNodesRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<InternetNodesRequest>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const InternetNodesRequest& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(InternetNodesRequest* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
...
class InternetNodesList final :
 ...
 public:
  ...
  inline InternetNodesList* New() const final {
    return new InternetNodesList();
  }

  InternetNodesList* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
class InternetNodesEntry final :
 ...
 public:
  ...
  inline InternetNodesEntry* New() const final {
    return new InternetNodesEntry();
  }

  InternetNodesEntry* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
