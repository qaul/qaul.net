...
inline bool Connections::has_internet_nodes_rename() const {
  return _internal_has_internet_nodes_rename();
}
...
inline void Connections::clear_internet_nodes_rename() {
  if (_internal_has_internet_nodes_rename()) {
    if (GetArenaForAllocation() == nullptr) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void InternetNodesEntry::set_name(ArgT0&& arg0, ArgT... args) {
...
inline void InternetNodesEntry::set_allocated_name(std::string* name) {
  if (name != nullptr) {
