...
::PROTOBUF_NAMESPACE_ID::uint8* Connections::_InternalSerialize(
...
inline void InternetNodesRequest::SharedCtor() {
}

InternetNodesRequest::~InternetNodesRequest() {
  // @@protoc_insertion_point(destructor:qaul.rpc.connections.InternetNodesRequest)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void InternetNodesRequest::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void InternetNodesRequest::ArenaDtor(void* object) {
  InternetNodesRequest* _this = reinterpret_cast< InternetNodesRequest* >(object);
  (void)_this;
}
void InternetNodesRequest::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void InternetNodesRequest::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void InternetNodesRequest::Clear() {
// @@protoc_insertion_point(message_clear_start:qaul.rpc.connections.InternetNodesRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* InternetNodesRequest::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* InternetNodesRequest::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:qaul.rpc.connections.InternetNodesRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:qaul.rpc.connections.InternetNodesRequest)
  return target;
}

size_t InternetNodesRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:qaul.rpc.connections.InternetNodesRequest)
  size_t total_size = 0;
...
void InternetNodesRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<InternetNodesRequest *>(to)->MergeFrom(
      static_cast<const InternetNodesRequest &>(from));
}


void InternetNodesRequest::MergeFrom(const InternetNodesRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:qaul.rpc.connections.InternetNodesRequest)
  GOOGLE_DCHECK_NE(&from, this);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void InternetNodesRequest::CopyFrom(const InternetNodesRequest& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:qaul.rpc.connections.InternetNodesRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool InternetNodesRequest::IsInitialized() const {
  return true;
}

void InternetNodesRequest::InternalSwap(InternetNodesRequest* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
}
...
::PROTOBUF_NAMESPACE_ID::uint8* InternetNodesList::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
::PROTOBUF_NAMESPACE_ID::uint8* InternetNodesEntry::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
