...
inline ::qaul::rpc::debug::LogToFile* Debug::release_log_to_file() {
  ...
  if (_internal_has_log_to_file()) {
    clear_has_message();
    ::qaul::rpc::debug::LogToFile* temp = message_.log_to_file_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    message_.log_to_file_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::qaul::rpc::debug::LogToFile* Debug::_internal_mutable_log_to_file() {
  if (!_internal_has_log_to_file()) {
    clear_message();
    set_has_log_to_file();
    message_.log_to_file_ = CreateMaybeMessage< ::qaul::rpc::debug::LogToFile >(GetArenaForAllocation());
  }
  return message_.log_to_file_;
}
...
inline void Debug::set_has_storage_path_request() {
  _oneof_case_[0] = kStoragePathRequest;
}
...
inline ::qaul::rpc::debug::StoragePathRequest* Debug::release_storage_path_request() {
  ...
  if (_internal_has_storage_path_request()) {
    clear_has_message();
    ::qaul::rpc::debug::StoragePathRequest* temp = message_.storage_path_request_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    message_.storage_path_request_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::qaul::rpc::debug::StoragePathRequest* Debug::_internal_mutable_storage_path_request() {
  if (!_internal_has_storage_path_request()) {
    clear_message();
    set_has_storage_path_request();
    message_.storage_path_request_ = CreateMaybeMessage< ::qaul::rpc::debug::StoragePathRequest >(GetArenaForAllocation());
  }
  return message_.storage_path_request_;
}
...
inline void Debug::set_has_storage_path_response() {
  _oneof_case_[0] = kStoragePathResponse;
}
...
inline ::qaul::rpc::debug::StoragePathResponse* Debug::release_storage_path_response() {
  ...
  if (_internal_has_storage_path_response()) {
    clear_has_message();
    ::qaul::rpc::debug::StoragePathResponse* temp = message_.storage_path_response_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    message_.storage_path_response_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::qaul::rpc::debug::StoragePathResponse* Debug::_internal_mutable_storage_path_response() {
  if (!_internal_has_storage_path_response()) {
    clear_message();
    set_has_storage_path_response();
    message_.storage_path_response_ = CreateMaybeMessage< ::qaul::rpc::debug::StoragePathResponse >(GetArenaForAllocation());
  }
  return message_.storage_path_response_;
}
...
inline void Debug::set_has_delete_libqaul_logs_request() {
  _oneof_case_[0] = kDeleteLibqaulLogsRequest;
}
...
inline ::qaul::rpc::debug::DeleteLibqaulLogsRequest* Debug::release_delete_libqaul_logs_request() {
  ...
  if (_internal_has_delete_libqaul_logs_request()) {
    clear_has_message();
    ::qaul::rpc::debug::DeleteLibqaulLogsRequest* temp = message_.delete_libqaul_logs_request_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    message_.delete_libqaul_logs_request_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::qaul::rpc::debug::DeleteLibqaulLogsRequest* Debug::_internal_mutable_delete_libqaul_logs_request() {
  if (!_internal_has_delete_libqaul_logs_request()) {
    clear_message();
    set_has_delete_libqaul_logs_request();
    message_.delete_libqaul_logs_request_ = CreateMaybeMessage< ::qaul::rpc::debug::DeleteLibqaulLogsRequest >(GetArenaForAllocation());
  }
  return message_.delete_libqaul_logs_request_;
}
...
void StoragePathResponse::set_storage_path(ArgT0&& arg0, ArgT... args) {
 ...
 storage_path_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void StoragePathResponse::_internal_set_storage_path(const std::string& value) {
  ...
  storage_path_.Set(value, GetArenaForAllocation());
}
inline std::string* StoragePathResponse::_internal_mutable_storage_path() {
  
  return storage_path_.Mutable(GetArenaForAllocation());
}
...
inline void StoragePathResponse::set_allocated_storage_path(std::string* storage_path) {
  ...
  storage_path_.SetAllocated(storage_path, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (storage_path_.IsDefault()) {
