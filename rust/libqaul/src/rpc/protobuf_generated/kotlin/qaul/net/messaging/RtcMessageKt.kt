...
inline fun rtcMessage(block: qaul.net.messaging.RtcMessageKt.Dsl.() -> kotlin.Unit): qaul.net.messaging.MessagingOuterClass.RtcMessage =
...
@kotlin.jvm.JvmSynthetic
inline fun qaul.net.messaging.MessagingOuterClass.RtcMessage.copy(block: qaul.net.messaging.RtcMessageKt.Dsl.() -> kotlin.Unit): qaul.net.messaging.MessagingOuterClass.RtcMessage =
