...
fn to_proto(
    ...
    let kind = match event.kind {
        ...
        RotationEventKind::GraceExpired => proto::RotationEventKind::GraceExpired,
        RotationEventKind::MessageDroppedPastGrace => {
            proto::RotationEventKind::MessageDroppedPastGrace
        }
    };
    proto::RotationEvent {
        kind: kind as i32,
