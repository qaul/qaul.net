...
impl ChatFile {
    ...
    */
    ...
    fn send(
        ...
        if let Err(e) = db_ref
            .histories
            .insert(&file_id.to_be_bytes(), file_history)
        {
            log::error!("Error saving file history to data base: {}", e);
        } else {
            if let Err(e) = db_ref.histories.flush() {
        ...
        // TODO change to this content
        // create chat file message content
        let _chat_filecontent = super::rpc_proto::FileContent {
            file_id,
            file_name,
    ...
    */
    ...
    fn process_info_message(
        ...
        // save to chat
        let file_container = proto_net::ChatFileContainer {
            message: Some(proto_net::chat_file_container::Message::FileInfo(file_info)),
        };
        ChatStorage::save_incoming_message(
            &user_account.id,
            &sender_id,
            super::rpc_proto::ChatContentType::File as i32,
            file_container.encode_to_vec(),
            sent_at,
            &conversation_id,
            &message_id,
