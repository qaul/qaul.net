...
impl MessagingProcess {
    ...
    pub fn on_direct_message(sender_id: &PeerId, receiver_id: &PeerId, data: &Vec<u8>, signature: &Vec<u8>){
       // decode mesaging
       let messaging;
       ...
       match messaging.message{
            ...
            Some(super::proto::messaging::Message::CommonMessage(common)) =>{
                ...
                log::error!("common msg_id={}, conversation_id={}", bs58::encode(common.message_id.clone()).into_string(), conversation_id.to_base58());
                ...
                match common.payload{
                    ...
                    Some(super::proto::common_message::Payload::GroupMessage(ref group_message)) =>{
                ...
                log::error!("sender={}, receiver={}", sender_id.to_base58(), receiver_id.to_base58());
            ...
            Ok(payload)=>{
                match payload.payload {
                    Some(super::proto::envelop_payload::Payload::Encrypted(encrypted)) =>{
                        ...
                        Self::on_direct_message(&sender_id, &receiver_id, &encrypted.data, &container.signature);
                    },
