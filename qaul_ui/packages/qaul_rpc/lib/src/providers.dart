...
import 'package:qaul_rpc/src/models/feed_message_list_notifier.dart';
...
final feedMessagesProvider =
    StateNotifierProvider<FeedMessageListNotifier, List<FeedMessage>>(
        (ref) => FeedMessageListNotifier(messages: const [
